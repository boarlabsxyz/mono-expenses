...
- For each scenario, provide strict `Given / When / Then` with concrete values and measurable outcomes:
  ...
  - When:
    ...
    - Example: `When I run "flow-test-go tools list"`
  - Then:
...
When I run:
"""
flow-test-go tools ./tests/e2e/testdata/flows/error-cases/single-step.json
"""
...
When I run:
"""
flow-test-go execute ./tests/e2e/testdata/flows/error-cases/github-step.json
"""
Then the exit code is 0
And stdout equals:
"""
